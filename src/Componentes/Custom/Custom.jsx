    ...
    <section id='section_estamp'>
      <div className='pruebas_s'>
        ...
        <div className='product_details_descripcion mod'>
          ...
          { pestaña === 'local' &&
            <motion.div variants={inicial} whileInView="visibles" initial="oculto" >
              <motion.p>Prueba a ver como queda cualquier imagen que puedas subir y nosotros te la presentamos en tu camiseta</motion.p>
              <motion.label variants={inicial}>
              <motion.input
              variants={inicial} 
              type="file"
              accept="image/*"
              ...
              className='jgj'
              />          
              <motion.div variants={inicial} className="generar">Archivo</motion.div> 
              <motion.div variants={inicial} className='customizada'>
              <h3>Color</h3>
               <input 
              ...
              <motion.div variants={inicial} className='carrito_talla'>
                <Dropdown onSizeChange={handleSizeChange} selectedSize={selectedSize}/>
                <motion.div variants={inicial} className='details_button'>
          ...
          <motion.div variants={inicial} whileInView="visibles" initial="oculto" className='ia_div'>
            <motion.p variants={inicial}>Escribe lo que te gustaría ver en el diseño y pondremos a nuestros mejores trolls a trabajar, ten en cuenta que el diseño que 
              aparezca es ÚNICO y cuando cargues otra imagen desaparecerá, ¡escoge bien!
            </motion.p>
            <motion.textarea variants={inicial} className="text_area" value={input} onChange={handleInputChange} />
            <motion.div variants={inicial} className='customizada'>
              <h3>Color</h3>
               <input 
                className='colors_input_2'
            ...
            <motion.button variants={inicial} whileTap={{scale:0.98}} className='generar' onClick={onSubmit}>Generar</motion.button>
          <motion.div className='carrito_talla'>
            <Dropdown onSizeChange={handleSizeChange} selectedSize={selectedSize}/>
            <motion.div className='details_button'>
            <Boton_2 onClick={()=>addCart()} className='boton_carrito_details estampados' texto_boton="Añadir al Carrito"/>
          </motion.div>
          </motion.div>
          </motion.div>
